...
export const tbCeFaq: FaqCategory[] = [
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, clustering is fully supported in the Community Edition. You can find more details about deployment scenarios <a target="_blank" href="/docs/reference/architecture/deployment-scenarios/">here</a>.</p>',
			},
			{
				id: 'ce-customize',
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, but performance may be limited due to hardware constraints. You can check details <a target="_blank" href="/docs/installation/">here</a>.</p>',
			},
			{
				id: 'ce-multi-tenancy',
