...
{ oldPath: 'user-guide/integrations/remote-integrations', target: '/docs/user-guide/integrations/' },
	...
	{ oldPath: 'paas/user-guide/api-limits', target: '/docs/paas/user-guide/billing-info/' },
	{ oldPath: 'paas/eu/user-guide/api-limits', target: '/docs/paas/eu/user-guide/billing-info/' },
