...
{ oldPath: 'user-guide/integrations/remote-integrations', target: '/docs/user-guide/integrations/' },
	...
	{ oldPath: 'user-guide/advanced-filters', target: '/docs/user-guide/dashboards//#filters' },
	{ oldPath: 'pe/user-guide/advanced-filters', target: '/docs/pe/user-guide/dashboards//#filters' },
	{ oldPath: 'paas/user-guide/advanced-filters', target: '/docs/paas/user-guide/dashboards//#filters' },
	{ oldPath: 'paas/eu/user-guide/advanced-filters', target: '/docs/paas/eu/user-guide/dashboards//#filters' },
