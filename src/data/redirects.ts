...
export const SINGLE_REDIRECTS: SingleRedirect[] = [
	...
	{ oldPath: 'user-guide/ssl/http-over-ssl', target: '/docs/reference/http-api/getting-connected/' },
	{ oldPath: 'pe/user-guide/ssl/coap-over-ssl', target: '/docs/reference/coap-api/getting-connected/#coap-over-dtls--server-configuration' },
	{ oldPath: 'pe/user-guide/ssl/http-over-ssl', target: '/docs/reference/http-api/getting-connected/#https-tls' },
	...
	{ oldPath: 'pe/user-guide/troubleshooting', target: '/docs/troubleshooting/' },
...
{ oldPath: 'user-guide/integrations/remote-integrations', target: '/docs/user-guide/integrations/' },
	...
	{ oldPath: 'pe/user-guide/mqtt-over-ssl', target: '/docs/reference/mqtt-api/getting-connected/#mqtt-over-tls' },
