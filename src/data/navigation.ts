	...
	groups: [
		{
			items: [
				{
					href: '/',
					icon: '/src/assets/images/thingsboard-cm-icon.svg',
				...
				},
				{
					...
					icon: '/src/assets/images/thingsboard-p-icon.svg',
				...
				{
					href: '/products/paas/',
					icon: '/src/assets/images/thingsboard-c-icon.svg',
					heading: 'Cloud',
			...
			items: [
				{
					...
					icon: '/src/assets/images/thingsboard-e-icon.svg',
					heading: 'Edge',
				...
				},
				{
					...
					icon: '/src/assets/images/gateway-icon.svg',
					heading: 'IoT Gateway',
				...
				},
				{
					...
					icon: '/src/assets/images/tb-mobile-icon.svg',
				...
				},
				{
					...
					icon: '/src/assets/images/tb-pe-mobile-icon.svg',
				...
				},
				{
					...
					icon: '/src/assets/images/tbmq-icon.svg',
					heading: 'TBMQ',
				...
				},
				{
					...
					icon: '/src/assets/images/trendz-icon.svg',
			...
			items: [
				{
					...
					icon: '/src/assets/images/development-services.svg',
					heading: 'Development services',
					description: 'IoT Solutions development',
				},
				{
					href: '/services/support/',
					icon: '/src/assets/images/support-icon.svg',
					heading: 'Support',
					description: 'Support packages',
				},
				{
					href: '/services/trainings/',
					icon: '/src/assets/images/train-icon.svg',
					heading: 'Trainings',
	...
	groups: [
		{
			items: [
				{
					href: '/case-studies/',
					icon: '/src/assets/images/case-studies.svg',
					heading: 'Case studies',
					linkClass: 'small-link',
				},
				{
					href: '/industries/smart-energy/',
					icon: '/src/assets/images/feedback.svg',
	...
	groups: [
		{
			items: [
				{
					href: '/company/',
					icon: '/src/assets/images/about-s-icon.svg',
					heading: 'Our company',
					linkClass: 'small-link',
				},
				{
					href: '/docs/contact-us/',
					icon: '/src/assets/images/contact-s-icon.svg',
					heading: 'Contact us',
					linkClass: 'small-link',
				},
				{
					href: '/mediakit/',
					icon: '/src/assets/images/media-s-icon.svg',
					heading: 'Media kit',
					linkClass: 'small-link',
				},
				{
					href: '/careers/',
					icon: '/src/assets/images/careers-s-icon.svg',
					heading: 'Careers',
					linkClass: 'small-link',
				},
			],
			...
			items: [
				{
					...
					icon: '/src/assets/images/hard-s-icon.svg',
					heading: 'Hardware partners',
					linkClass: 'small-link',
				},
				{
					href: '/partners/distributors/',
					icon: '/src/assets/images/dis-s-icon.svg',
					heading: 'Distributors',
					linkClass: 'small-link',
				},
				{
					href: '/partners/marketplace/',
					icon: '/src/assets/images/marketplace-s-icon.svg',
					heading: 'Marketplace',
					linkClass: 'small-link',
				},
			],
