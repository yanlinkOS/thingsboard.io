---
title: Calculated field contribution guide
...
Each calculated field version is identified by a semver string (e.g. `1.0.0`) plus a changelog entry, and a SHA-256 **checksum** computed from:
