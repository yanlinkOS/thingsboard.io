...
5. Re-zip the folder contents (not the folder itself) and upload via **IoT Hub → + Add new item**. The upload form asks for the target edition (CE, PE, or both), version, categories, and use cases — see [Editions](#editions).
</Steps>
