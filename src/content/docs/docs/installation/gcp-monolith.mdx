...
The process of configuring the load balancer with Google-managed SSL certificates is described in the <a href="https://cloud.google.com/kubernetes-engine/docs/how-to/managed-certs" target="_blank">official documentation</a>. Make sure you read the <a href="https://cloud.google.com/kubernetes-engine/docs/how-to/managed-certs#prerequisites" target="_blank">prerequisites</a>.
