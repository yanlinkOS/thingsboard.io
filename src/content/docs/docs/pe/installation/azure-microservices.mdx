...
This guide walks you through deploying ThingsBoard PE in microservices mode on <a href="https://azure.microsoft.com/en-us/products/kubernetes-service" target="_blank">Azure Kubernetes Service (AKS)</a>. We use Azure Database for PostgreSQL as the managed database.
...
## Step 7. Obtain and configure license key
