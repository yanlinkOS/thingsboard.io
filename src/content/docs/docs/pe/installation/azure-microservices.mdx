...
Use the address to access the web UI and connect devices via <DocLink product={Products.PE} path="reference/http-api">HTTP API</DocLink>.
...
For MQTT over SSL, follow the <DocLink product={Products.PE} path="user-guide/mqtt-over-ssl">MQTT over SSL</DocLink> guide to configure `transport/tb-mqtt-transport.yml`.
...
For CoAP over DTLS, follow the <DocLink product={Products.PE} path="user-guide/coap-over-dtls">CoAP over DTLS</DocLink> guide to configure `transport/tb-coap-transport.yml`.
...
For LwM2M over DTLS, follow the <DocLink product={Products.PE} path="user-guide/ssl/lwm2m-over-dtls">LwM2M over DTLS</DocLink> guide to configure `transport/tb-lwm2m-transport.yml`.
