...
See the <a href="https://docs.cloud.google.com/kubernetes-engine/docs/how-to/managed-certs" target="_blank">official documentation</a> for Google-managed SSL certificates. Reserve a static IP:
