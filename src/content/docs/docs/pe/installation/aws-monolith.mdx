...
Follow the <DocLink product={Products.PE} path="reference/mqtt-api/getting-connected#mqtt-over-tls">MQTT over SSL</DocLink> guide to create a `.pem` file. Store it as `server.pem` in the working directory.
