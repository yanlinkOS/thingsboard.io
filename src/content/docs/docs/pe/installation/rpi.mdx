...
export const downloadDeb = `wget https://dist.thingsboard.io/thingsboard-${PE_PKG_VER}.deb`;
export const installDeb = `sudo dpkg -i thingsboard-${PE_PKG_VER}.deb`;
export const downloadWebReport = `wget https://dist.thingsboard.io/tb-web-report-${PE_PKG_VER}.deb`;
