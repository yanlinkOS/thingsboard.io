...
For MQTT over SSL, follow the <DocLink product={Products.PE} path="user-guide/mqtt-over-ssl">MQTT over SSL</DocLink> guide to configure the required environment variables in `tb-node.yml`.
