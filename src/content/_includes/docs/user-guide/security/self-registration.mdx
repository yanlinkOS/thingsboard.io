...
|---|---|
| **ThingsBoard PE instance** | A running instance accessible via a public IP address. See <DocLink product={props.product} path="installation">installation options</DocLink> |
...
<Aside type="tip">
The self-registration sign-up form appearance (logo, colors, background) is controlled by the <DocLink product={props.product} path="user-guide/white-labeling-login">Login white-labeling</DocLink> settings for the selected domain.
</Aside>
