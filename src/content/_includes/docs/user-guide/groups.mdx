...
**Entity Groups** let you organize <DocLink product={props.product} path='user-guide/devices'>devices</DocLink>, <DocLink product={props.product} path='user-guide/assets'>assets</DocLink>, <DocLink product={props.product} path='user-guide/entity-views'>entity views</DocLink>, <DocLink product={props.product} path='user-guide/customers'>customers</DocLink>, <DocLink product={props.product} path='user-guide/users'>users</DocLink>, <DocLink product={props.product} path='user-guide/dashboards'>dashboards</DocLink>, and <DocLink product={props.product} path='user-guide/edge-computing'>edge instances</DocLink> into custom collections. Each entity can belong to multiple groups simultaneously. A special **"All"** group always contains every entity of a given type within the tenant.
...
4. Optionally configure sharing with a customer (see [Share a group](#share-a-group) below).
5. Click **Add**.
</Steps>
...
Define who can access the entities inside this group and what actions they can perform. A permission entry links a **group <DocLink product={props.product} path='user-guide/roles'>role</DocLink>** to a **user group** and applies only to entities within this group.
...
For controlled access to specific customers, use [Share a group](#share-a-group) or configure entries on the [Permissions](#permissions) tab instead.
