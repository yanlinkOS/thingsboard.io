...
- Completed the <DocLink product={props.product} path="getting-started-guides/helloworld">Getting Started</DocLink> guide;
...
Fields like "Name", "Hint", and "Group title" support internationalization using the 'i18n' tag. For instance: `{i18n:scada.fan.turn-on}`. For more details on setting up custom translations, see <DocLink product={Products.PE} path="user-guide/custom-translation">Localization</DocLink>.
...
Possible widget actions are detailed in the <DocLink product={props.product} path="user-guide/ui/widget-actions">Widget Actions</DocLink> documentation.
