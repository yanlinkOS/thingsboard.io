...
<Aside type="note">Available since ThingsBoard 3.8.0.</Aside>

In ThingsBoard, SCADA symbols are built with <a href="https://en.wikipedia.org/wiki/SVG" target="_blank" rel="noopener noreferrer">SVG</a> (Scalable Vector Graphics),
which scales seamlessly across screen sizes due to its vector nature.
ThingsBoard extends the SVG format to support interactivity.
This guide walks you through creating your own interactive SCADA symbol using a sample SVG file.

<YouTubeVideo videoId="kBMcsg7YEcQ" title="SCADA symbols development guide" />

## Prerequisites

To effectively follow this guide, ensure you have:

- Completed the <DocLink product={props.product} path="getting-started">Getting Started</DocLink> guide;
- Reviewed the <DocLink product={props.product} path="user-guide/scada">SCADA Dashboards</DocLink> documentation;
- Acquired a basic understanding of <a href="https://www.w3schools.com/graphics/svg_intro.asp" target="_blank" rel="noopener noreferrer">SVG</a>.

Having experience with <a href="https://svgjs.dev/" target="_blank" rel="noopener noreferrer">SVG.js</a> will be beneficial for tackling advanced scenarios.
...
- **Tags**: Custom labels assigned to shapes in the SVG file. Used to specify render functions and `onClick` actions for SVG elements.

- **Behavior**: Defines how a SCADA symbol receives data from the platform and what actions it triggers on devices or dashboards.

- **Properties**: Configuration elements for end users that allow customization of the widget's appearance.
...
<DocImage src="/src/assets/images/user-guide/scada-symbol-dev/fan.svg" alt="FAN SVG" width={300} />

*Figure: Static SVG image including a fan, text label, and two buttons.*

The goal is to convert this static SVG into an interactive widget that reflects the fan state in real time.
...
<Steps>
1. Right-click on the SVG file shown below and select "Save image as" to save the file to your PC.
</Steps>

<DocImage src="/src/assets/images/user-guide/scada-symbol-dev/fan.svg" alt="FAN SVG" width={300} />

<Steps>
2. Navigate to the "Resources" page of the "SCADA symbols" section and click the "Upload SCADA symbol" button.
3. Drop the `fan.svg` file in the appropriate field, or upload it from a folder on your computer, rename it to "Fan", and click "Upload".
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/upload-svg-file-1.png', alt: 'Upload SCADA symbol' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/upload-svg-file-2.png', alt: 'Upload SVG file' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/explore-scada-editor-1.png', alt: 'SCADA symbol editor layout' },
]} />

### SCADA Editor Actions

- **Create Widget** - this button allows you to quickly create a widget based on your SCADA symbol. Any major changes to the SCADA symbol will automatically reflect in the <DocLink product={props.product} path="reference/widgets/widget-library" bold={false}>widget library</DocLink>, except for fields like title, description, and search tags, which are copied at the moment you create the widget.
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/scada-editor-actions-1.png', alt: 'SCADA editor actions' },
]} />

As a simple exercise, populate the description and search tags, then click "Apply".

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/scada-editor-actions-2.png', alt: 'SCADA editor apply changes' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/widget-size-and-aspect-ratio-1.png', alt: 'Widget size and aspect ratio' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-editor-1.png', alt: 'Tags definition via editor step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-editor-2.png', alt: 'Tags definition via editor step 2' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-editor-3.png', alt: 'Tags definition via editor step 3' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-editor-4.png', alt: 'Tags definition via editor step 4' },
]} />
...
<Steps>
1. Navigate to the "XML" editor mode and replace this XML code:
</Steps>
...
<Steps>
2. Return to the "SVG" editor mode. You will see the tags added to the "On" button element.
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-tags-to-on-button-1.png', alt: 'Add tags to On button step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-tags-to-on-button-2.png', alt: 'Add tags to On button step 2' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-tags-to-on-button-3.png', alt: 'Add tags to On button step 3' },
]} />
...
<Steps>
2. Navigate to the "XML" editor mode.
3. Paste the copied code in the corresponding window.
4. Return to the "SVG" editor mode. You can see the defined tags. Afterward, apply the changes.
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-xml-1.png', alt: 'Tags definition via XML step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-xml-2.png', alt: 'Tags definition via XML step 2' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/tags-definition-via-xml-3.png', alt: 'Tags definition via XML step 3' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/operations-with-tag-1.png', alt: 'Update tag step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/operations-with-tag-2.png', alt: 'Update tag step 2' },
]} />

**Tag settings**

<Steps>
1. Hover over the tag and click the "Tag settings" icon.
2. In the pop-up menu, there are two types of functions you may assign to each tag: "State render function" and "On click action". We will discuss these in more detail in the "[Tag configurations](#step-6-tag-functions)" section.
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/operations-with-tag-3.png', alt: 'Tag settings step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/operations-with-tag-4.png', alt: 'Tag settings step 2' },
]} />

**Remove tag**

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/operations-with-tag-5.png', alt: 'Remove tag step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/operations-with-tag-6.png', alt: 'Remove tag step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/behavior-scada-developer-end-user-configuration-1.png', alt: 'Behavior items - SCADA developer configuration' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/behavior-scada-developer-end-user-configuration-2.png', alt: 'Behavior items - end-user configuration' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-behavior-1.png', alt: 'Add behavior step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-behavior-2.png', alt: 'Add behavior step 2' },
]} />

Fields like "Name", "Hint", and "Group title" support internationalization using the 'i18n' tag. For instance: `{i18n:scada.fan.turn-on}`. For more details on setting up custom translations, see <DocLink product={Products.PE} path="user-guide/white-labeling-translation">Localization</DocLink>.
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/types-of-behavior-parameters-1.png', alt: 'Types of behavior parameters' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/five-types-of-actions-1.png', alt: 'Do nothing action type' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/five-types-of-actions-2.png', alt: 'Execute RPC action type' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/five-types-of-actions-3.png', alt: 'Get attribute action type' },
]} />

- **Get time series** action type subscribes to a target entity's time series field, updating the widget with new data arrivals.

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/five-types-of-actions-4.png', alt: 'Get time series action type' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/five-types-of-actions-5.png', alt: 'Get alarm status action type' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/five-types-of-actions-6.png', alt: 'Get dashboard state action type' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/three-types-of-actions-for-interacting-with-target-entity-1.png', alt: 'Execute RPC action' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/three-types-of-actions-for-interacting-with-target-entity-2.png', alt: 'Set attribute action' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/three-types-of-actions-for-interacting-with-target-entity-3.png', alt: 'Add time series action' },
]} />
...
Possible widget actions are detailed in the <DocLink product={props.product} path="user-guide/actions">Widget Actions</DocLink> documentation.

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/widget-action-1.png', alt: 'Widget action configuration' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/value-types-1.png', alt: 'Value types' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-on-behavior-1.png', alt: 'Add fanOn behavior step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-on-behavior-2.png', alt: 'Add fanOn behavior step 2' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-on-behavior-3.png', alt: 'Add fanOn behavior step 3' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-speed-behavior-1.png', alt: 'Add fanSpeed behavior step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-speed-behavior-2.png', alt: 'Add fanSpeed behavior step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-on-btn-click-behavior-1.png', alt: 'Add onBtnClick behavior step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-on-btn-click-behavior-2.png', alt: 'Add onBtnClick behavior step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-off-btn-click-behavior-1.png', alt: 'Add offBtnClick behavior step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-off-btn-click-behavior-2.png', alt: 'Add offBtnClick behavior step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/widget-action-2.png', alt: 'Widget action - onFanClick step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/widget-action-3.png', alt: 'Widget action - onFanClick step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/properties-scada-developer-end-user-configuration-1.png', alt: 'Properties - SCADA developer configuration' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/properties-scada-developer-end-user-configuration-2.png', alt: 'Properties - end-user configuration' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-properties-1.png', alt: 'Add property step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-properties-2.png', alt: 'Add property step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-on-btn-label-1.png', alt: 'Add On button label step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-on-btn-label-2.png', alt: 'Add On button label step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-on-btn-color-1.png', alt: 'Add On button color' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-on-btn-disabled-color-1.png', alt: 'Add On button disabled color' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-off-btn-label-1.png', alt: 'Add Off button label step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-off-btn-label-2.png', alt: 'Add Off button label step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-off-btn-color-1.png', alt: 'Add Off button color' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-off-btn-disabled-color-1.png', alt: 'Add Off button disabled color' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-on-color-1.png', alt: 'Add fan On color' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-off-color-1.png', alt: 'Add fan Off color step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-fan-off-color-2.png', alt: 'Add fan Off color step 2' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-show-rotation-speed-1.png', alt: 'Add show rotation speed switch' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-rotation-speed-unit-1.png', alt: 'Add rotation speed unit' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-rotation-speed-font-1.png', alt: 'Add rotation speed font' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/add-rotation-speed-color-1.png', alt: 'Add rotation speed color' },
]} />

List of configured properties should look like this:

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/configured-properties-1.png', alt: 'Configured properties list' },
]} />
...
This JS function is responsible for changing the SVG element via <a href="https://svgjs.dev/" target="_blank" rel="noopener noreferrer">SVG.js</a> API and accepts two parameters:

* *ctx* is an instance of [ScadaSymbolContext](#scadasymbolcontext);
* *element* is an <a href="https://svgjs.dev/" target="_blank" rel="noopener noreferrer">SVG.js</a> element;
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/state-render-function-1.png', alt: 'State render function - tag level' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/state-render-function-2.png', alt: 'State render function - global level' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-click-action-1.png', alt: 'On click action - tag level' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-click-action-2.png', alt: 'On click action - global level' },
]} />
...
<Steps>
1. Go to the "Tag settings" of the "`onButtonText`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<Steps>
3. Paste copied function into the appropriate window. Click "Apply".
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-text-tag-configuration-1.png', alt: 'onButtonText tag configuration step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-text-tag-configuration-2.png', alt: 'onButtonText tag configuration step 2' },
]} />
...
Similar to [onButtonText](#onbuttontext-tag):

<Steps>
1. Go to the "Tag settings" of the "`offButtonText`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function.
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-text-tag-configuration-1.png', alt: 'offButtonText tag configuration step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-text-tag-configuration-2.png', alt: 'offButtonText tag configuration step 2' },
]} />
...
- `ctx.properties` is used to access the value of the `offBtnLabel` property.
...
<Steps>
1. Go to the "Tag settings" of the "`onButtonBackground`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-background-tag-configuration-1.png', alt: 'onButtonBackground tag configuration step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-background-tag-configuration-2.png', alt: 'onButtonBackground tag configuration step 2' },
]} />
...
Similar to [onButtonBackground](#onbuttonbackground-tag):

<Steps>
1. Go to the "Tag settings" of the "`offButtonBackground`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-background-tag-configuration-1.png', alt: 'offButtonBackground tag configuration step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-background-tag-configuration-2.png', alt: 'offButtonBackground tag configuration step 2' },
]} />
...
- `ctx.properties` is used to access the value of the `offBtnColor` and `offBtnDisabledColor` color properties.
...
<Steps>
1. Go to the "Tag settings" of the "`onButton`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-tag-configuration-1.png', alt: 'onButton tag state render step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-tag-configuration-2.png', alt: 'onButton tag state render step 2' },
]} />
...
<Steps>
1. Go to the "Tag settings" of the "`onButton`" tag and click "+ Add" button of a "On click action".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-tag-configuration-3.png', alt: 'onButton tag on click action step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/on-button-tag-configuration-4.png', alt: 'onButton tag on click action step 2' },
]} />
...
Similar to [onButton](#onbutton-tag), the state render function:

<Steps>
1. Go to the "Tag settings" of the "`offButton`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-tag-configuration-1.png', alt: 'offButton tag state render step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-tag-configuration-2.png', alt: 'offButton tag state render step 2' },
]} />
...
<Steps>
1. Go to the "Tag settings" of the "`offButton`" tag and click "+ Add" button of "On click action".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-tag-configuration-3.png', alt: 'offButton tag on click action step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/off-button-tag-configuration-4.png', alt: 'offButton tag on click action step 2' },
]} />
...
- `ctx.api.callAction` triggers the action defined by the `offBtnClick` behavior item;

- `callAction` accepts an event, actionId, optional parameters, and an Observer instance to handle the result;

- On successful action execution, the `next` function sets the `fanOn` value to false;
...
<Steps>
1. Go to the "Tag settings" of the "`rotationSpeedText`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/rotation-speed-text-tag-configuration-1.png', alt: 'rotationSpeedText tag configuration step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/rotation-speed-text-tag-configuration-2.png', alt: 'rotationSpeedText tag configuration step 2' },
]} />
...
Although the function is quite simple, it requires basic knowledge of <a href="https://svgjs.dev/" target="_blank" rel="noopener noreferrer">SVG.js</a>. Key points:

- Line 3: we use `element.remember` getter from <a href="https://svgjs.dev/docs/3.2/manipulating/#remember-as-getter" target="_blank" rel="noopener noreferrer">SVG.js</a> to get the state of the animation;

- Line 9: we use `element.remember` setter from <a href="https://svgjs.dev/docs/3.2/manipulating/#remember-as-setter" target="_blank" rel="noopener noreferrer">SVG.js</a> to set the state of the animation. It is important to avoid initialization of the animation on each call of the render function;

- Line 11: we use `element.timeline.speed` from <a href="https://svgjs.dev/docs/3.2/animating/" target="_blank" rel="noopener noreferrer">SVG.js</a> to define the speed of our animation that we convert from RPM to RPS;

- Line 14: we use `element.timeline.pause` from <a href="https://svgjs.dev/docs/3.2/animating/" target="_blank" rel="noopener noreferrer">SVG.js</a> to stop the animation if the fan is turned off;

The <a href="https://svgjs.dev/" target="_blank" rel="noopener noreferrer">SVG.js</a> animation is feature rich but has some performance impact on the main browser thread. We propose an alternative approach that utilizes CSS animation:

<Steps>
1. Go to the "Tag settings" of the "`fan`" tag and click "+ Add" button of a "State rendering function".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/fan-tag-configuration-1.png', alt: 'Fan tag state render step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/fan-tag-configuration-2.png', alt: 'Fan tag state render step 2' },
]} />
...
* Line 8: we use `ctx.api.cssAnimate` to create a new instance of [ScadaSymbolAnimation](#scadasymbolanimation) object that providing controls similar to SVG.js's <a href="https://svgjs.dev/docs/3.2/animating/#svg-runner" target="_blank" rel="noopener noreferrer">Runner</a>;
...
Now let's define the on click action for the fan:

<Steps>
1. Go to the "Tag settings" of the "`fan`" tag and click "+ Add" button of "On click action".
2. Copy the function:
</Steps>
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/fan-tag-configuration-3.png', alt: 'Fan tag on click action step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/fan-tag-configuration-4.png', alt: 'Fan tag on click action step 2' },
]} />
...
<Steps>
1. Press the green "On" button. The button will become unclickable, its color should change to gray, the fan will change color from red to green and start spinning. The fan's RPM value will display beneath it. Meanwhile, the "Off" button will become active and change its color from gray to red. Press it.
2. The fan should stop, the "Off" button will become unclickable, and its color will turn gray again.
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/preview-mode-1.png', alt: 'Preview mode - initial state' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/preview-mode-2.png', alt: 'Preview mode - fan on' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/preview-mode-3.png', alt: 'Preview mode - configuration' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/preview-mode-4.png', alt: 'Preview mode - fan off' },
]} />
...
<Steps>
1. Click the "Create widget" button in the upper right corner.
2. In the new window, enter the name of the future widget and specify an existing widget bundle or create a new one. We will create a new one. Enter the desired name for it and click "Create new widget bundle".
3. Optionally, add a preview image for the widget bundle and click "Add".
4. Confirm the widget creation by clicking the "Create" button.
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/create-widget-1.png', alt: 'Create widget step 1' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/create-widget-2.png', alt: 'Create widget step 2' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/create-widget-3.png', alt: 'Create widget step 3' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/create-widget-4.png', alt: 'Create widget step 4' },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/download-scada-symbol-1.png', alt: 'Download SCADA symbol' },
]} />

Here is an example of a configured SCADA symbol:

<DocImage src="/src/assets/images/user-guide/scada-symbol-dev/configured_fan.svg" alt="Configured FAN SVG" width={300} />
...
<Steps>
1. Create a new dashboard or open existing one. Navigate to the "Layouts" settings, and change the layout from "Default" to "SCADA". Click "Save".
2. Now, click the "Add widget" button at the top of the screen or click the large "Add new widget" icon in the center of the screen.
3. Find the "My SCADA widgets" widget bundle and click on it.
4. Click on the "Fan" widget to add it to the dashboard.
5. Specify the target device (use any device), and click "Add".
6. Widget added. Click "Save" to save the changes to the dashboard.
7. Click the green "On" button. The button will become unclickable, its color should change to gray, the fan will change color from red to green and start spinning. The fan's RPM value will display beneath it.
8. Meanwhile, the "Off" button will become active and change its color from gray to red. Press it. The fan should stop, the "Off" button will become unclickable, and its color will turn gray again.
</Steps>

<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-1.png', alt: 'Test widget - create dashboard' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-2.png', alt: 'Test widget - add widget' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-3.png', alt: 'Test widget - select bundle' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-4.png', alt: 'Test widget - select Fan widget' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-5.png', alt: 'Test widget - specify device' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-6.png', alt: 'Test widget - widget added' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-7.png', alt: 'Test widget - fan on state' },
  { src: '/src/assets/images/user-guide/scada-symbol-dev/test-widget-on-dashboard-8.png', alt: 'Test widget - fan off state' },
]} />
...
* **formatValue** (overload): Formats numeric values using a settings object.
   ```javascript
...
* **text**: Sets or updates the text content of one or more SVG elements. Only applicable for elements of type <a href="https://svgjs.dev/docs/3.2/shape-elements/#svg-text" target="_blank" rel="noopener noreferrer">SVG.Text</a> and <a href="https://svgjs.dev/docs/3.2/shape-elements/#svg-tspan" target="_blank" rel="noopener noreferrer">SVG.Tspan</a>.
   ```javascript
...
* **font**: Applies font styling and color to text elements. Only applicable for elements of type <a href="https://svgjs.dev/docs/3.2/shape-elements/#svg-text" target="_blank" rel="noopener noreferrer">SVG.Text</a> and <a href="https://svgjs.dev/docs/3.2/shape-elements/#svg-tspan" target="_blank" rel="noopener noreferrer">SVG.Tspan</a>.
   ```javascript
...
* **icon**: Embeds an icon within SVG elements, with optional parameters for size, color, and center alignment. Only applicable for elements of type <a href="https://svgjs.dev/docs/3.2/container-elements/#svg-g" target="_blank" rel="noopener noreferrer">SVG.G</a>.
   ```javascript
  ...
  **Parameters**:
    - **element**: SVG element or an array of SVG elements.
    - **icon**: Icon to draw. <a href="https://mdisearch.com/" target="_blank" rel="noopener noreferrer">MDI</a> icons supported. Typically obtained from `ctx.properties`.
...
* **cssAnimate**: Starts a CSS-based animation, providing controls similar to those available in SVG.js's <a href="https://svgjs.dev/docs/3.2/animating/#svg-runner" target="_blank" rel="noopener noreferrer">Runner</a>. Finishes any previous CSS animation.
   ```javascript
...
* **transform**: Applies a matrix transform to the animated element.
  ...
  **Parameters**:
    - **transform**: The transformation object similar to <a href="https://svgjs.dev/docs/3.2/manipulating/#transform-as-setter" target="_blank" rel="noopener noreferrer">SVG.js</a> but with the following supported properties:
