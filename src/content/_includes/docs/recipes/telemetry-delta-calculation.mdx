...
Publish two temperature values within a 15-minute interval. Use <DocLink product={props.product} path="user-guide/devices/#check-connectivity">Check connectivity</DocLink> or the commands below.
