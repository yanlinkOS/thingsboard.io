...
Publish test telemetry values using <DocLink product={props.product} path="user-guide/ui/devices/#check-connectivity">Check connectivity</DocLink> or the `curl` commands below.
