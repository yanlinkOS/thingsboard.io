...
Review the <DocLink product={props.product} path="user-guide/rule-engine-2-0/overview">Rule Engine</DocLink> documentation before proceeding — it explains message routing and processing concepts used in this guide.
...
<Aside type="note">
  ...
  )} You can also use <DocLink product={props.product} path="user-guide/ui/devices/#check-connectivity">Check connectivity</DocLink> to get a ready-to-run command.
</Aside>
...
- <DocLink product={props.product} path="user-guide/rule-engine-2-0/overview">Rule Engine overview</DocLink> — full reference for message routing and processing
- <DocLink product={props.product} path="user-guide/rule-engine-2-0/nodes/filter/script">Script filter node</DocLink> — write custom JavaScript conditions for message filtering
