...
| Default queues | Main, HighPriority, SequentialByOriginator | Main, HighPriority, SequentialByOriginator | Main, HighPriority, SequentialByOriginator | Main, HighPriority, SequentialByOriginator | Main, HighPriority, SequentialByOriginator |
