...
- **Enabled** (default) — use the platform-wide <DocLink product={props.product} path="user-guide/ui/mail-settings">SMTP settings</DocLink> configured by the system administrator.
