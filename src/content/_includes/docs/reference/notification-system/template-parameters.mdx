...
Renders as: *ThingsBoard 3.7.0 is available* / *A new version is available. You are on 3.6.4. Upgrade to 3.7.0: `https://thingsboard.io/docs/installation/upgrade-instructions/`*
