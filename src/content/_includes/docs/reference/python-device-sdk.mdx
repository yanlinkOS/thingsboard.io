...
<Aside type="tip">
The SDK implements all <DocLink product={props.product} path='reference/mqtt-api/getting-connected'>MQTT Device API</DocLink> features: telemetry upload, attribute subscriptions, server-side RPC, and device provisioning.
</Aside>
