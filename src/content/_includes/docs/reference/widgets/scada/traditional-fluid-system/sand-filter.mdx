...
<Image
  ...
  width={120}
  style={{ float: 'left', marginRight: '1.25rem', marginBottom: '0.5rem', width: '120px', height: '199px', objectFit: 'contain' }}
/>
