...
It represents an oil pump — a surface-mounted pumping unit used to lift crude oil from a well. The widget visualizes the pump across various operational states: it shows whether the pump is currently running and lifting fluid, and highlights warning or critical conditions with configurable colors and a blinking animation. Use it on artificial lift management dashboards, well surveillance systems, or production optimization applications to monitor pump activity, surface equipment alarms, and pump-off conditions, and navigate to per-well detail views with a single click.
