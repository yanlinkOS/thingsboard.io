...
It represents an industrial crane rendered as a tower-and-boom assembly. The widget supports motion animation when the crane is operating, per-state click actions for warning and critical alarm conditions, and a unified blinking animation covering both alarm states. 
