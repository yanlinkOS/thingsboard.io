...
It represents a group of end consumers — residential, commercial, or industrial buildings that draw electricity, gas, water, or heat from a distribution network. The widget shows whether the consumer group is actively being supplied (running state) and highlights warning or critical conditions with configurable colors and a blinking animation. 

Use it on smart grid, district heating, water distribution, or utility management dashboards to visualize load zones and surface supply or demand alerts directly on the diagram.
