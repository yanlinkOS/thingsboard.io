...
It renders a 90-degree elbow connector with openings at the bottom and right, and an optional animated fluid flow stripe. 

Use it wherever a pipe path changes direction from upward vertical to horizontal — for example, routing flow rising from a pump or tank below and turning it right toward a filter, valve, or next stage — in HVAC, water treatment, industrial automation, or building management systems. Combine it with straight connectors and other elbow variants to build complete flow paths across a diagram.
