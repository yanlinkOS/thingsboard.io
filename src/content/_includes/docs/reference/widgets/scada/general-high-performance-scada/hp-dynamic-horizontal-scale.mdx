...
|---|---|---|
| **Title** | `HP Dynamic horizontal scale` | Widget title displayed in the header. Supports `entityName` and `entityLabel` variables. |
...
- <a href="/use-cases/scada/">**SCADA Swimming pool**</a> — a complete swimming pool monitoring dashboard that uses the HP Dynamic horizontal scale to display sensor readings with device-specific warning and critical thresholds.
