...
The ThingsBoard Java REST Client wraps the <DocLink product={props.product} path='reference/rest-api'>REST API</DocLink> and lets Java applications manage devices, assets, dashboards, customers, and other platform entities programmatically. It is built on Spring `RestTemplate`.

<Aside type="tip">
For a Python alternative, see the <DocLink product={props.product} path='reference/python-rest-client'>Python REST Client</DocLink>.
Complete examples are available in the [tb-ce-rest-client-example](https://github.com/thingsboard/tb-ce-rest-client-example) repository.
</Aside>
...
See the [tb-ce-rest-client-example](https://github.com/thingsboard/tb-ce-rest-client-example) repository for complete runnable examples.
