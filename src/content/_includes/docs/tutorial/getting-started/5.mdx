...
<Steps>
  ...
  &#8226;&#8194;**Send activation mail** — sends the activation link to the specified email address (requires a configured <DocLink product={props.product} path='user-guide/white-labeling-mail'>mail server</DocLink>).
...
<Aside type="tip">
  **Optionally**
  ...
  <Steps>
  1. Click the user to open its details.
