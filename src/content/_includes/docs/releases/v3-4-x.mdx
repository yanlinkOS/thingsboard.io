...
* Core & Rule Engine:
  * [#6534](https://github.com/thingsboard/thingsboard/pull/6534) Configuration of Rule Engine queues via Tenant Profiles. See [Rule Engine Queues documentation](/docs/user-guide/rule-engine/queues/);
  * [#6070](https://github.com/thingsboard/thingsboard/issues/6070) 2FA support. See [Two-Factor Authentication documentation](/docs/user-guide/security/two-factor-authentication/).
