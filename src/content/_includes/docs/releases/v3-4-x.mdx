...
* Core:
  * Improved performance and stability of the [Device State Service](/docs/user-guide/device-connectivity-status/);
...
* Core & Rule Engine:
  * [#6534](https://github.com/thingsboard/thingsboard/pull/6534) Configuration of Rule Engine queues via Tenant Profiles. See [Rule Engine Queues documentation](/docs/user-guide/rule-engine-2-5/queues/);
  * [#6070](https://github.com/thingsboard/thingsboard/issues/6070) 2FA support. See [Two-Factor Authentication documentation](/docs/user-guide/two-factor-authentication/).
  * [#6759](https://github.com/thingsboard/thingsboard/pull/6759) Version Control (Git integration). See [Version Control documentation](/docs/user-guide/version-control/).
