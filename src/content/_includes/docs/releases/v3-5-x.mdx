...
* Core & Rule Engine
  ...
  * [#7935](https://github.com/thingsboard/thingsboard/pull/7935) [Device provisioning](/docs/reference/mqtt-api/getting-connected/#x509-certificate) using X509 certificate chains by @AndriiLandiak
