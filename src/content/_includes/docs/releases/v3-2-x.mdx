...
* Migration to JDK 11;
* Rule Engine:
    * Added ["calculate delta"](/docs/reference/rule-engine/nodes/enrichment/) rule node;
    ...
    * Added kafka consumer-groups statistics. See rule engine [troubleshooting](/docs/user-guide/rule-engine/#troubleshooting) for more info;
    * Attributes cache. See [Performance enhancement](/docs/user-guide/digital-twins/attributes/#performance-enhancement);
* UI:
    ...
    * Added column visibility and [row style](/docs/reference/widgets/entity-table-widget/) functions for table widgets;
 ...
 * Added support of custom [MQTT Topics](/docs/user-guide/device-profiles/#mqtt-device-topic-filters) and basic [MQTT credentials](/docs/reference/mqtt-api/getting-connected/#mqtt-basic) as alternative to access token;
 ...
 * [SMS Provider](/docs/user-guide/ui/sms-provider-settings/) and [Send SMS](/docs/reference/rule-engine/nodes/external/) rule node;
