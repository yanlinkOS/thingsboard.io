...
* Rule Engine:
    ...
    * Added "current customer" and "current tenant" dynamic source types to DeviceProfile key filter. See examples [6](/docs/user-guide/device-profiles/#alarm-rules) and [7](/docs/user-guide/device-profiles/#alarm-rules);
    ...
    * Attributes cache. See [Performance enhancement](/docs/user-guide/digital-twins/attributes/);
* UI:
    ...
    * Added column visibility and [row style](/docs/user-guide/ui/entity-table-widget/#row-style-function) functions for table widgets;
 ...
 * Added support of custom [MQTT Topics](/docs/user-guide/device-profiles/#transport-configuration) and basic [MQTT credentials](/docs/user-guide/basic-mqtt/) as alternative to access token;
