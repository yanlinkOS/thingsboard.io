...
{/* TODO: these link to internal /docs/... paths — verify the pages exist in this site and convert to <DocLink> if so; also verify whether the anchor (#step-6-...) is supported */}
For Ubuntu Server, see <a href="/docs/pe/installation/" target="_blank" rel="noopener noreferrer">Step 6: Configure Edge TLS communication</a>.

For CentOS/RHEL Server, see <a href="/docs/pe/installation/" target="_blank" rel="noopener noreferrer">Step 6: Configure Edge TLS communication</a>.
