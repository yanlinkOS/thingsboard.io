...
For Ubuntu and CentOS/RHEL Server, see {props.product === 'EDGE_PE' ? <DocLink product="PE" path="installation/haproxy#step-6-configure-edge-tls-communication-optional">Step 6: Configure Edge TLS communication</DocLink> : <DocLink product="CE" path="installation/haproxy#step-6-configure-edge-tls-communication-optional">Step 6: Configure Edge TLS communication</DocLink>} in the HAProxy installation guide.
