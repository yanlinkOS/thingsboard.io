...
For the full rule node reference, see <DocLink product={props.product === Products.EDGE_PE ? Products.PE : Products.CE} path="user-guide/rule-engine-2-0/nodes/action/rpc-call-request-node" target="_blank">RPC call request</DocLink>.
...
For the full rule node reference, see <DocLink product={props.product === Products.EDGE_PE ? Products.PE : Products.CE} path="user-guide/rule-engine-2-0/nodes/action/rpc-call-reply-node" target="_blank">RPC call reply</DocLink>.
