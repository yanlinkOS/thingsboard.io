...
<DocImage src="/src/assets/images/docs/edge/edge-and-other-components.svg" alt="Diagram showing the relationship between ThingsBoard Edge, ThingsBoard Server, and IoT Gateway" width="800px" />
...
<DocLink product={Products.GW} path="" target="_blank">ThingsBoard IoT Gateway</DocLink> is a separate component for connecting devices that use protocols ThingsBoard does not natively support: Modbus, OPC-UA, and others. It translates those protocols into ThingsBoard's data model and forwards data upstream.
