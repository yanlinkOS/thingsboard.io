...
See the [before you begin](https://cloud.google.com/kubernetes-engine/docs/how-to/creating-a-zonal-cluster#before_you_begin) guide for more info.
...
- `us-central1` — one of the available compute [regions](https://cloud.google.com/compute/docs/regions-zones#available), referenced as `$GCP_REGION`
...
For a full list of available machine types, refer to the [GCP machine types documentation](https://cloud.google.com/compute/docs/machine-resource).
...
Alternatively, use [this guide](https://cloud.google.com/kubernetes-engine/docs/how-to/creating-a-regional-cluster) for a custom cluster setup.
...
<DocLink product={props.product} path="install/cluster/gcp-cluster-setup/#enable-gcp-services">enable the required GCP services</DocLink>,
then follow the <DocLink product={props.product} path="install/cluster/gcp-cluster-setup/#step-5-provision-google-cloud-sql-postgresql-instance">Cloud SQL provisioning instructions</DocLink>.
...
official [GKE documentation](https://cloud.google.com/kubernetes-engine/docs/how-to/managed-certs).
