...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-http-integration.png', alt: 'TBMQ HTTP integration data flow' },
]} />

## Prerequisites

- A running <DocLink product={props.product} path="install/installation-options">TBMQ</DocLink> instance.
- An external service ready to receive HTTP requests (e.g., <a href="https://thingsboard.io/docs/paas/getting-started-guides/what-is-thingsboard-cloud/" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a>).
...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/tb-endpoint-url-1.png', alt: 'Copy HTTP endpoint URL from ThingsBoard Cloud integration details' },
]} />
...
<ImageGallery product={props.product} images={[
  ...
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-http-integration-2.png', alt: 'Select HTTP as the integration type and click Next' },
  ...
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-http-integration-4.png', alt: 'Paste the Endpoint URL from ThingsBoard' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-http-integration-5.png', alt: 'Open Advanced settings, set Payload content type to JSON, and click Add' },
]} />
...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/integration-events-1.png', alt: 'Lifecycle events for the HTTP integration' },
...
<ImageGallery product={props.product} images={[
  ...
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/send-uplink-message-2.png', alt: 'Set topic to tbmq/http-integration and click Send' },
]} />
...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/http-integration-result-1.png', alt: 'Open ThingsBoard Cloud HTTP integration details' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/http-integration-result-2.png', alt: 'Events tab showing the message received from TBMQ HTTP integration' },
]} />
