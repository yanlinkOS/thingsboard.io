...
**Helm chart support:** Official <DocLink product={props.product} path="install/installation-options">Helm chart</DocLink> for deploying TBMQ is now available, enabling simplified Kubernetes deployments with customizable configuration options.
