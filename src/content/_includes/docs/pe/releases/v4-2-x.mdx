...
Everything from [CE v4.2.2.3](/docs/releases/releases-table/v4-2-x/#v4223-jul-1-2026) with the following fixes.
...
Everything from [CE v4.2.2.2](/docs/releases/releases-table/v4-2-x/#v4222-may-28-2026) with the following fixes.
