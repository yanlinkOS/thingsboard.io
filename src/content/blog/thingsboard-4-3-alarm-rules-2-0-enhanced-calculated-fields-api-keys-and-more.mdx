...
For detailed information, please refer to the [Alarm Rules documentation](/docs/user-guide/alarm-rules/?utm_source=blog&utm_medium=post&utm_campaign=release43).
...
- **[Geofencing](/docs/user-guide/calculated-fields/geofencing-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Define operational zones and detect enter/exit events and presence status.
- **[Propagation](/docs/user-guide/calculated-fields/propagation-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Roll up data across entity relations (parent/child visibility).
- **[Related Entities Aggregation](/docs/user-guide/calculated-fields/related-entities-aggregation-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Aggregate metrics across linked entities.
- **[Time Series Data Aggregation](/docs/user-guide/calculated-fields/time-series-data-aggregation-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Rollups for KPI dashboards and analytics.
...
For detailed information, please refer to the [Calculated Fields documentation](/docs/user-guide/calculated-fields/?utm_source=blog&utm_medium=post&utm_campaign=release43).
...
- **Developer Experience:** The [Java](/docs/reference/rest-client/?utm_source=blog&utm_medium=post&utm_campaign=release43) and [Python](/docs/reference/python-rest-client/?utm_source=blog&utm_medium=post&utm_campaign=release43) REST Client has been updated with the API Keys support.
