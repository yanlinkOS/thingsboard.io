...
- **[Geofencing](https://thingsboard.io/docs/user-guide/calculated-fields/geofencing-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Define operational zones and detect enter/exit events and presence status.
- **[Propagation](https://thingsboard.io/docs/user-guide/calculated-fields/propagation-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Roll up data across entity relations (parent/child visibility).
- **[Related Entities Aggregation](https://thingsboard.io/docs/user-guide/calculated-fields/related-entities-aggregation-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Aggregate metrics across linked entities.
- **[Time Series Data Aggregation](https://thingsboard.io/docs/user-guide/calculated-fields/time-series-data-aggregation-calculated-field/?utm_source=blog&utm_medium=post&utm_campaign=release43)**: Rollups for KPI dashboards and analytics.
...
Administrators can now [force](https://thingsboard.io/docs/user-guide/two-factor-authentication/?utm_source=blog&utm_medium=post&utm_campaign=release43) Two-Factor Authentication (2FA) at the system level for all users, tenant administrators, or system administrators only. To ensure a smooth transition, enforcement can be targeted to specific **Tenants** or **Tenant Profiles** for controlled rollouts.
...
- **Developer Experience:** The [Java](https://thingsboard.io/docs/reference/rest-client/?utm_source=blog&utm_medium=post&utm_campaign=release43) and [Python](https://thingsboard.io/docs/reference/python-rest-client/?utm_source=blog&utm_medium=post&utm_campaign=release43) REST Client has been updated with the API Keys support.
