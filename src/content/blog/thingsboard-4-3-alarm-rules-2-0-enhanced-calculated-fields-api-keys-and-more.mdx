...
- **Developer Experience:** The [Java](/docs/reference/java-rest-client/?utm_source=blog&utm_medium=post&utm_campaign=release43) and [Python](/docs/reference/python-rest-client/?utm_source=blog&utm_medium=post&utm_campaign=release43) REST Client has been updated with the API Keys support.
