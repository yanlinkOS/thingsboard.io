---
title: 'Build, Ship, Evolve: ThingsBoard CLI Brings Infrastructure as Code to IoT'
description: 'ThingsBoard CLI works with Claude Code to build IoT solutions from scratch, evolve anything already running in your tenant, and ship the same configuration to every environment — Infrastructure as Code, native to IoT.'
date: 2026-06-10
updatedDate: 2026-06-10
author: iryna-matveieva
categories: ['updates']
featuredImage: '/images/blog/thingsboard-cli/cover.webp'
featuredImageAlt: 'ThingsBoard CLI — Infrastructure as Code for IoT'
draft: false
---
import BlogCTA from '~/components/Blog/BlogCTA.astro';

A few months ago we said: *"Turn prompts into an IoT prototype in 10 minutes."* That was [AI Solution Creator](/blog/ai-solution-creator/).
...
It's Infrastructure as Code, finally native to IoT.
...
## Why IaC Matters for IoT

For years, modern software has been moving toward Infrastructure as Code (IaC) — your setup described in files, kept under version control, deployed reproducibly across environments. IoT platforms haven't made that jump. Configuration lives in the UI, drift becomes the default, and nobody can remember what changed and why.

ThingsBoard CLI changes that. Your whole entity setup lives as JSON files in a folder you control — so you can version it in git, restore a previous version, and deploy with a single command. It stops being something locked behind a login and becomes something you can read, diff, and own.
...
<div class="cli-image-gallery">
  <img src="/images/blog/thingsboard-cli/evolve-something-1.webp" alt="ThingsBoard CLI applying a natural-language update to an existing Waste Management solution" />
  <img src="/images/blog/thingsboard-cli/evolve-something-2.webp" alt="Waste Management dashboard before and after the per-bin alarm threshold update" />
</div>
...
**Promote it everywhere.** The same project files can be pushed to dev, staging, and prod under different profiles: `tb push smart-building --profile prod`. Same files. Different targets. Pushes are idempotent — push the same solution a hundred times and nothing duplicates. Configuration drift becomes a memory.
