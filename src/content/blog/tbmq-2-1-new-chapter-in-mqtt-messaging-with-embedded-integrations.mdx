...
We’re excited to announce the release of TBMQ [2.1.0](https://thingsboard.io/docs/mqtt-broker/releases)! This version marks a major milestone by introducing the Integration Executor microservice, which is responsible for managing integrations. It powers scalable and multi-protocol message delivery to external systems, starting with support for HTTP, Kafka, and MQTT outbound integrations. We’ve also released the official [Helm Chart](https://thingsboard.io/docs/mqtt-broker/install/cluster/helm-cluster-setup-options/) for TBMQ, simplifying deployment and management of the infrastructure in K8s environments.
