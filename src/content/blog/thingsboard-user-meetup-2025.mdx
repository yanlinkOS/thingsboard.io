...
You can watch the presentation [here](https://data.it-novum.com/video/thingsboard-user-meetup-vol-6-product-update-thingsboard/), or read about the major updates in the [3.7](https://thingsboard.io/blog/thingsboard-3-7-release/), [3.8](https://thingsboard.io/blog/thingsboard-3-8-0-release/), [3.9](https://thingsboard.io/blog/thingsboard-3-9-0-release/) releases below.
...
The original SCADA dashboards were introduced in the [ThingsBoard 3.8.0](https://thingsboard.io/blog/thingsboard-3-8-0-release/). The widgets had different colors and complex graphics, resulting in visual distractions and poor status indicators.
...
[ThingsBoard 3.9.0 release](https://thingsboard.io/blog/thingsboard-3-9-0-release/) aimed to popularize mobile applications for the convenience of our users.
...
- Starting with [release 3.8](https://thingsboard.io/blog/thingsboard-3-8-0-release/), JSON is no longer required to manage custom menus – all configurations can be done through the Web UI.
...
The next speaker, Michael Deuchert, Head of Professional Services at it-novum, [shared his experience](https://data.it-novum.com/video/thingsboard-user-meetup-vol-6-5-jahre-trendz-analytics/) with [Trendz Analytics](https://thingsboard.io/products/trendz/). He focused on the on the efficient and intuitive analysis of ThingsBoard data.
