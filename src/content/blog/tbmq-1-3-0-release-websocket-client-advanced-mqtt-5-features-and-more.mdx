...
We have added the new WebSocket client – a browser-accessible tool that greatly simplifies the debugging and testing of MQTT clients across various scenarios. Utilizing the [MQTT over WebSocket ](/docs/mqtt-broker/user-guide/mqtt-over-ws/)feature, this tool offers a user-friendly interface for a range of functionalities. Key features include:
