...
Imagine not only asking your ThingsBoard platform questions like “Show me all gateways that reported offline in the last hour” or “List alarms for device X and their severities” (as we did in [version 1.0](/blog/introducing-thingsboard-mcp-natural-language-access-to-your-iot-platform/)) but now also running complex queries across entities, writing or updating devices, assets, alarms, users and more – all via a unified protocol. With ThingsBoard MCP 2.0 that vision becomes reality.
