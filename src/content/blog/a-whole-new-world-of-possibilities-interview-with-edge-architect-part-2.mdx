...
Welcome back to Part 2 of our conversation with Volodymyr Babak – [ThingsBoard Edge](/docs/edge/getting-started-guides/what-is-edge/) solution architect! In the [Part 1](/blog/a-whole-new-world-of-possibilities-interview-with-edge-architect-part-1/) of this interview, we explored the origins of ThingsBoard Edge. Now, let’s shift our focus to the technical breakthroughs and what to expect in the future releases. Let’s get started!
...
*As for ThingsBoard Edge, it’s often mistaken for [ThingsBoard IoT Gateway](/docs/iot-gateway/what-is-iot-gateway/) (which is a Python-based software). But actually, ThingsBoard Edge is more than just a simple gateway. It’s a full-fledged computing platform with advanced data processing, local automation, and seamless cloud integration. It’s built to handle much more than just data forwarding.*
