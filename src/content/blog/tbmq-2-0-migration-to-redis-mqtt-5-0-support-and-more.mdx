...
We’re delighted to introduce TBMQ version 2.0.0! This release brings a major update with data migration of [persistent sessions for devices](/docs/mqtt-broker/architecture/#persistent-device-client) from PostgreSQL to Redis. It also expands TBMQ’s MQTT 5.0 feature set, achieving full compatibility with the MQTT 5.0 standard. Here’s an overview of the features and updates included in this release.
...
This release brings a range of meaningful enhancements, each designed to improve the system’s transparency, security, and performance, paving the way for a more reliable and efficient MQTT experience. We invite you to try out these powerful new features by [installing the latest version of TBMQ](/docs/mqtt-broker/install/installation-options/).
