...
We’re excited to introduce a new JavaScript library in the Resources section. This library features two types of resources: Modules and Extensions. [Extensions](https://thingsboard.io/docs/user-guide/contribution/ui/advanced-development/), which are Angular components, have been part of previous releases and have now been migrated to the new JavaScript library.
