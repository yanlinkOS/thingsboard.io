...
ThingsBoard also offers **[Irrigation Management](https://thingsboard.io/docs/pe/solution-templates/smart-irrigation/)** and **[Water Metering](https://thingsboard.io/docs/pe/solution-templates/water-metering/)** solution templates right out of the box. These templates make it super easy for any ThingsBoard user to create and customise their own irrigation system, saving time and effort.
