...
Install now for [Ubuntu](/docs/user-guide/install/edge/deb-installation/), [CentOS/RHEL Server](/docs/user-guide/install/edge/rhel/) , or [using Docker (Linux or Mac OS)](/docs/user-guide/install/edge/docker/).
...
Now is the perfect time to embrace these powerful updates and take your IoT solutions to the next level. [Update to ThingsBoard Edge 3.9.0](/docs/user-guide/install/edge/upgrade-instructions/#upgrading-to-39) today and experience the difference—where innovation meets efficiency to drive your success forward.

Uncover the newly enhanced power of [ThingsBoard Edge](/docs/edge/getting-started-guides/what-is-edge/)!
