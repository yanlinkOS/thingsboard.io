...
We're excited to introduce [TBMQ Professional Edition](https://thingsboard.io/docs/pe/mqtt-broker/) (TBMQ PE) – the next step in the evolution of our MQTT broker. TBMQ PE is built on top of [TBMQ's](https://thingsboard.io/products/mqtt-broker/) proven, production-ready core and adds advanced features for security, observability, integration, and professional support. Starting with this release, the existing open-source version will be known as [TBMQ Community Edition](https://thingsboard.io/docs/mqtt-broker/) (TBMQ CE).
...
Here's how the two editions align in terms of core features, security, extensibility, and support. See the full comparison table [here](https://thingsboard.io/products/mqtt-broker/#comparison-features).
...
<BlogCTA
  ...
  buttons={[
    { text: "Upgrade", href: "https://thingsboard.io/docs/mqtt-broker/install/upgrade-instructions/" },
    { text: "Try 30 Days for Free", href: "https://thingsboard.io/pricing/?section=tbmq-options&product=tbmq-pe", variant: "outline" }
  ]}
/>
...
Check out our [Single Sign-On (SSO) / OAuth2](https://thingsboard.io/docs/pe/mqtt-broker/security/oauth-2-support/) guide.
...
Check out our [RBAC](https://thingsboard.io/docs/pe/mqtt-broker/security/rbac/) guide.
...
Check out our[ ](https://thingsboard.io/docs/pe/mqtt-broker/security/rbac/)[White labeling](https://thingsboard.io/docs/pe/mqtt-broker/white-labeling/) guide.
...
<BlogCTA
  ...
  buttons={[
    { text: "Book a Live Demo", href: "https://thingsboard.io/docs/contact-us/?subject=TBMQ" }
  ]}
/>
...
Getting started is seamless: configure your requirements on the [TBMQ pricing page](https://thingsboard.io/pricing/?section=tbmq-options&product=tbmq-pe), then proceed to the ThingsBoard Licensing Server to activate your license. If you do not have an account, the system will guide you through the creation process during activation.
