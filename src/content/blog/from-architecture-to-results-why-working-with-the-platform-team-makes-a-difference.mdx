...
<p style={{fontSize:'15px',lineHeight:'1.65',margin:0,color:'var(--color-text-secondary)'}}>For anyone who needs acceleration of IoT project, with built-in security and an eye toward future requirements, collaborating with an <a href="https://thingsboard.io/services/development-services/">IoT development service</a> by platform is the most balanced choice.</p>
</div>
<div style={{padding:'28px 24px'}}>
...
<BlogCTA
  ...
  buttons={[
    { text: "Discover our approach", href: "https://thingsboard.io/services/development-services/" }
  ]}
/>
...
<BlogCTA
  ...
  buttons={[
    { text: "Request a consultation", href: "https://thingsboard.io/services/development-services/" }
  ]}
/>
