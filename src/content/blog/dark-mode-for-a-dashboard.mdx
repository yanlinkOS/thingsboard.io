...
description: 'Add dark mode to a ThingsBoard dashboard with a custom action toggle: a switch button, a CSS class, and per-widget styling for the Smart Energy use case.'
date: 2024-11-19
...
<video
  ...
  loop
  playsInline
  poster="/images/blog/dark-mode-for-a-dashboard/DarkMode-2-poster.jpg"
  aria-label="Dark mode toggle demo on a ThingsBoard dashboard"
  style={{ display: 'block', maxWidth: '100%', height: 'auto', margin: '1.5rem auto', borderRadius: '6px' }}
>
  <source src="/images/blog/dark-mode-for-a-dashboard/DarkMode-2.mp4" type="video/mp4" />
</video>
