...
- In the widget settings, you can define the display <a href="/docs/user-guide/widgets/#widget-time-window" target="_blank" rel="noopener noreferrer">time window</a>.
